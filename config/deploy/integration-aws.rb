...
role :app, %w{jenkins@newcatalog7.library.cornell.edu}
role :web, %w{jenkins@newcatalog7.library.cornell.edu}
role :db, %w{jenkins@newcatalog7.library.cornell.edu}, :primary => true
