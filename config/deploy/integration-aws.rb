role :app, "newcatalog-int-aws.library.cornell.edu"
role :web, "newcatalog-int-aws.library.cornell.edu" 
role :db,  "newcatalog-int-aws.library.cornell.edu", :primary => true
