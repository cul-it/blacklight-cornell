$(function () {
  ...
  $('a').click(function () {
      ...
      if (identifier === 'facets') {
        var action = $(this).parents("div:first").find("h5:first").text();
      } else {
        var action = 'clicked';
      }
  ...
  //$('#facets h5').live('click', function(){
  $(document).on('click','#facets h5', function(){
    var label = $(this).text();
  ...
  $('h2.blacklight-title_display a').click(function(){
