...
(function ($) {
  $.fn.blCheckboxSubmit = function (argOpts) {
    ...
    this.each(function () {
      ...
      // we're hiding the forms in the _bookmark_control partial because the transition
      // from button to checkmark is ugly in BL7. Now unhide them.
  ...
  $.fn.blCheckboxSubmit.defaults = {
    ...
    error: function () {
      alert("Unable to process all selections.");
    },
