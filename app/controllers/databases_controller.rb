...
class DatabasesController < ApplicationController
  ...
  def subject
     clnt = HTTPClient.new
      @anthroString = clnt.get_content("http://da-dev-solr.library.cornell.edu/solr/blacklight/databases?q=%22Anthropology+%28Core%29%22&&wt=ruby")
      ...
      @statisticalString = clnt.get_content("http://da-dev-solr.library.cornell.edu/solr/blacklight/databases?q=%22Statistical+Information%22&wt=ruby")
