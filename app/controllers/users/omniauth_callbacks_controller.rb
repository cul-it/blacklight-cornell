...
#https://www.interexchange.org/articles/engineering/lets-devise-google-oauth-login/
 ...
 msg << jgr25_context
 msg << "request.env omniauth: " + request.env["omniauth.auth"].env.inspect unless request.env.["omniauth.auth"].nil?
 msg << "request.env origin: " + request.env["omniauth.origin"].env.inspect unless request.env.["omniauth.origin"].nil?
 msg << "request.env returnpath: " + request.env["omniauth.returnpath"].env.inspect unless request.env.["omniauth.returnpath"].nil?
