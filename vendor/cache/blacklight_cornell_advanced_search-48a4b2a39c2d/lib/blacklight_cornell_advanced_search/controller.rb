require 'blacklight_cornell_advanced_search/parsing_nesting_parser'
...
module BlacklightCornellAdvancedSearch::Controller
  ...
  included do
    ...
    helper BlacklightCornellAdvancedSearch::RenderConstraintsOverride
    helper BlacklightCornellAdvancedSearch::CatalogHelperOverride
  end
  ...
  def add_advanced_search_to_solr(solr_parameters, req_params = params)
    ...
    if ( (req_params[:search_field] == self.blacklight_config.advanced_search[:url_key]) ||
      ...
      @advanced_query = BlacklightCornellAdvancedSearch::QueryParser.new(req_params, self.blacklight_config )      
      BlacklightCornellAdvancedSearch.deep_merge!(solr_parameters, @advanced_query.to_solr )
