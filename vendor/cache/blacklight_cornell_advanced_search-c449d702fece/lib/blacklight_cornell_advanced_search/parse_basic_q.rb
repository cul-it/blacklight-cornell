...
module BlacklightCornellAdvancedSearch::ParseBasicQ
  ...
  # BlacklightCornellAdvancedSearch init code will add it to CatalogController
  ...
  def add_advanced_parse_q_to_solr(solr_parameters, req_params = params)
    unless req_params[:q].blank?
      ...
      begin
        ...
        BlacklightCornellAdvancedSearch.deep_merge!(solr_parameters, solr_direct_params)
        BlacklightCornellAdvancedSearch.deep_merge!(solr_parameters, adv_search_params)        
