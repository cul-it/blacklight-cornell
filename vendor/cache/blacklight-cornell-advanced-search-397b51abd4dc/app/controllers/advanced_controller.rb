...
# etc. It does that right now because BlacklightCornellAdvancedSearch::AdvancedController
...
# _directly_ < CatalogController, and BlacklightCornellAdvancedSearch::AdvancedController
...
# which still mixes in BlacklightCornellAdvancedSearch::AdvancedController. There
# are probably some other edges that need to be smoothed for that approach, but
# that'd be the direction. 
class AdvancedController < BlacklightCornellAdvancedSearch::AdvancedController
