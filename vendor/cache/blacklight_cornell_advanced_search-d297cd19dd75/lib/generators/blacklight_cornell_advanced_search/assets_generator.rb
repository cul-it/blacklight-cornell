# Copy BlacklightCornellAdvancedSearch assets to public folder in current app. 
...
#       require File.join(BlacklightCornellAdvancedSearch.root, "lib", "generators", "blacklight", "assets_generator.rb")
#       BlacklightCornellAdvancedSearch::AssetsGenerator.start(["--force", "--quiet"])
...
module BlacklightCornellAdvancedSearch
  class AssetsGenerator < Rails::Generators::Base
    source_root File.join(BlacklightCornellAdvancedSearch::Engine.root, 'app', 'assets')

    def assets
      original_css = File.binread("app/assets/stylesheets/application.css")
      if original_css.include?("require 'blacklight_cornell_advanced_search'")
      ...
      if original_js.include?("require 'blacklight_cornell_advanced_search'")
