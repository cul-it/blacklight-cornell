module BlacklightCornellRequests
  ...
  class VoyagerRequest
    ...
    DB     = 'CORNELLDB20021226150546'
    DB_ID     = "1@#{DB}"
    REST_URL  = 'http://catalog-test.library.cornell.edu:7074/vxws'
  ...
  def cancel_any_item!(type,holdid)
          ...
          http_client do |hc|
            begin
               ...
               # 104305/circulationActions/requests?institution=LOCAL&patron_homedb=1@CORNELLDB20021226150546
