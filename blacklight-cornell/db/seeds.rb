...
Location.create("voyager_id"=>113, "code"=>"orni", "display_name"=>"Lab of Ornithology", "hours_page"=>"orni", "rmc_aeon"=>false)
Location.create("voyager_id"=>114, "code"=>"orni,ref", "display_name"=>"Lab of Ornithology Reference", "hours_page"=>"orni_ref", "rmc_aeon"=>false)
