...
# gem 'blacklight_cornell_requests', :path =>'/Users/jgr25/Documents/active/discovery_and_access/blacklight-cornell-requests'
...
# gem 'my_account', :path => '/Users/jgr25/Documents/active/discovery_and_access/cul-my-account'
gem 'borrow_direct', :git => 'https://github.com/jrochkind/borrow_direct'
gem 'ruby-saml', '>= 1.12.1'
gem 'bento_search', '~> 2.0.0.rc1'
# gem 'bento_search', :path => '/Users/jgr25/Documents/active/discovery_and_access/bento_search'
