...
gem 'blacklight-hierarchy', :git => 'git@github.com:cul-it/blacklight-cornell-hierarchy.git', :branch => 'master'
gem 'htmlentities'
gem 'json'
gem 'httpclient'
gem 'haml'
...
gem 'my_account', :git => 'https://github.com/cul-it/cul-my-account', :branch => 'BL7-upgrade'
