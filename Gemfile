...
# gem 'blacklight_cornell_advanced_search', :path => '/Users/mhk33/Documents/github/blacklight-cornell-advanced-search', :branch => 'bl5'
...
#gem 'blacklight_cornell_requests', :path => '/users/mjc12/code/blacklight-cornell-requests'
