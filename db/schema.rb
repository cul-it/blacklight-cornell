...
ActiveRecord::Schema.define(version: 20170920143824) do
  ...
  create_table "erm_data", id: false, force: :cascade do |t|
    ...
    t.text     "Reviewer_Note",                                    limit: 16777215
    ...
    t.text     "License_Note",                                     limit: 16777215
    t.datetime "Date_Created"
    t.datetime "Last_Updated"
    t.text     "Template_Note",                                    limit: 16777215
    t.string   "Authorized_Users",                                 limit: 256
    t.text     "Authorized_Users_Note",                            limit: 16777215
    t.binary   "Concurrent_Users",                                 limit: 65535
    t.text     "Concurrent_Users_Note",                            limit: 16777215
    ...
    t.text     "Print_Copy_Note",                                  limit: 16777215
    t.string   "Scholarly_Sharing",                                limit: 128
    t.text     "Scholarly_Sharing_Note",                           limit: 16777215
    t.string   "Distance_Learning",                                limit: 128
    t.text     "Distance_Learning_Note",                           limit: 16777215
    ...
    t.text     "ILL_Record_Keeping_Note",                          limit: 16777215
    t.string   "Course_Reserve",                                   limit: 128
    t.text     "Course_Reserve_Note",                              limit: 16777215
    t.string   "Electronic_Link",                                  limit: 128
    t.text     "Electronic_Link_Note",                             limit: 16777215
    ...
    t.text     "Remote_Access_Note",                               limit: 16777215
    t.binary   "Other_Use_Restrictions_Staff_Note",                limit: 65535
    t.text     "Other_Use_Restrictions_Public_Note",               limit: 16777215
    t.string   "Perpetual_Access_Right",                           limit: 128
    t.text     "Perpetual_Access_Note",                            limit: 16777215
    ...
    t.text     "Licensee_Termination_Note",                        limit: 16777215
    ...
    t.text     "Licensor_Termination_Note",                        limit: 16777215
    ...
    t.text     "Termination_Right_Note",                           limit: 16777215
    t.string   "Termination_Requirements",                         limit: 256
    t.string   "Termination_Requirements_Note",                    limit: 256
    t.text     "Terms_Note",                                       limit: 16777215
    t.text     "Local_Use_Terms_Note",                             limit: 16777215
    ...
    t.text     "Archiving_Note",                                   limit: 16777215
    ...
    t.text     "Pre_Print_Archive_Note",                           limit: 16777215
    ...
    t.text     "Incorporation_Of_Images_Figures_And_Tables_Note",  limit: 16777215
    t.string   "Public_Performance_Right",                         limit: 256
    t.text     "Public_Performance_Note",                          limit: 16777215
    t.string   "Training_Materials_Right",                         limit: 256
    t.text     "Training_Materials_Note",                          limit: 16777215
  end
