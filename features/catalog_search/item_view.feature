...
#    Then it should have link "mlink" with value "mailto:cul-dafeedback-l#@cornell.edu"
  ...
  Scenario: View an items holdings
    Given I request the item view for 120634
    Then I should see the label 'Request'
  #@all_item_view
  #@aeon
  #@rmcnoitems
  Scenario: View an items holdings
    Given I request the item view for 2073985
    Then I should see the label 'Request'
  ##@all_item_view
  ##@aeon
  #  #@reading_room_delivery
  #Scenario: View an items holdings, and request from aeon
  #  Given I request the item view for 277880
  #      #And click on link "Request for Reading Room Delivery"
  #      Then it should have link "Request item for Reading Room Delivery" with value "http://voy-api.library.cornell.edu/aeon/monograph.php?bibid=277880&libid=rmc,anx&finding="
  #@all_item_view
  #@aeon
  #Scenario: View an items holdings, and request from aeon
  #  Given I request the item view for 277880
  ...
  #Scenario: View an items holdings, and request from aeon
  #  Given I request the item view for 277880
  #      Then it should have link "Request for Reading Room Delivery" with value "/aeon/277880"
  ...
  Scenario: As a user, the author's name in an item record is clickable and produces a query resulting in a list of works by that author.
    Given I request the item view for 2073985
    And click on link "Cornell University. Graduate School."
    Then results should have a "author" that looks sort of like "Cornell University. Graduate School"
  ...
  Scenario: As a user, the subject headings in an item record are clickable and produces a query resulting in a list of items.
    Given I request the item view for 1003756
    And I should see the label 'Dialectical materialism.'
    And click on link "Dialectical materialism."
    Then it should contain filter "Subject" with value "Dialectical materialism."
  ...
  # DISCOVERYACCESS-138 Test should work after index is updated
  #@all_item_view
  ...
  Scenario: As a user I can see the publication date, publisher and place of publication on one line in the item record view.
    ...
    Then it should contain "pub_info" with value "Minneapolis : University of Minnesota Press, c1982."

  #@aeon
  #These tests already commented out, should work once Folio index is updated
  #@all_item_view
  #Scenario: View an items holdings, and request from aeon
  ...
  Scenario: As a user, the author's name in an item record is clickable and produces a query resulting in a list of works by that author.
    Given I request the item view for 595322
    And click on link "Jauss, Hans Robert."
    Then results should have a "author" that looks sort of like "Jauss, Hans Robert."

 
  # DISCOVERYACCESS-138  Should work once Folio index is updated
  #@all_item_view
 # Scenario: As a user, the "other names" in an item record is clickable and produces a query resulting in a list of items related to the other name chosen.
 #   Given I request the item view for 4442
 #   And click on link "Peabody, William Bourn Oliver, 1799-1847"
 #   Then I should see the label 'Lives of Alexander Wilson and Captain John Smith'
  ...
  # DISCOVERYACCESS-142 Duplicate test see above DISCOVERYACCESS-142
  #@all_item_view
#  Scenario: As a user I can see the publication date, publisher and place of publication on one line in the item record view.
...
#    Then it should contain "pub_info" with value "Berlin ; New York : Springer-Verlag, c1985."
  ...
  #  Given I request the item view for 595322
  #  Then it should have link "Request item" with value "/request/595322"
  ...
  Scenario: As a user I can request an item, when SAML involved.
    Given I request the item view for 595322
    Then it should have link "Request" with value "/request/auth/595322?scan=yes"
  ...
  Scenario: As a user I can see the availability for an item
    Given I request the item view for 595322
    Then I should see the label 'Olin Library'

  #Should work after Folio index has been updated down to line
